 ...
 * @polymer
 */
class IntroView extends LitElement {
  static get styles() {
    ...
    return html`
      <main>
        ...
        <p>
          ...
          Toggle between the themes by clicking the button below or by pressing
          <kbd>T</kbd> on your keyboard.
        </p>
        <p>
          <vaadin-button @click="${this.toggleTheme}"
            >Toggle Theme</vaadin-button
          >
        </p>

        <h2>Basic examples</h2>
        <p>
          Examples showcasing individual building blocks or specific features
          for creating layouts. Note that the examples marked with "CSS Grid"
          are implemented using
          <a
            href="https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Grid_Layout"
            >CSS Grid Layout</a
          >
          which is a very flexible way to create layouts but notably doesn't
          work in IE 11, Safari 9 or older browsers.
        </p>
        <div class="card-list">
          <ex-card>
        ...
        <div class="card-list">
          <ex-card>
            <a slot="title" router-link href="three-columns"
              >Three Columns (CSS Grid)</a
            >
            <p>A grid layout with header, footer and two sidebars</p>
          </ex-card>
          <ex-card>
            <a slot="title" router-link href="two-columns"
              >Two Columns (CSS Grid)</a
            >
            <p>A grid layout with header, footer and one sidebar</p>
          </ex-card>
          <ex-card>
            <a slot="title" router-link href="centered-content"
              >Centered Content</a
            >
        ...
        <p>
          Styled ready to use layouts which you may use as is or customize to
          your liking.
        </p>
        <div class="card-list">
          <ex-card>
          ...
          <ex-card>
            <a slot="title" router-link href="fixed-nav-sticky-footer"
              >Fixed Nav &amp; Sticky Footer</a
            >
            <p>
              Navigation bar fixed to the top of the viewport. Footer at the
              bottom of the viewport will get pushed down if there is more
              content than fits the viewport.
            </p>
          </ex-card>
          <ex-card>
            <a slot="title" router-link href="app-layout-basic"
              >Basic App Layout</a
            >
            <p>
              A basic example of using
              <a href="https://vaadin.com/components/vaadin-app-layout/"
                ><code>AppLayout</code></a
              >
            </p>
          </ex-card>
          <ex-card>
          ...
          <ex-card>
            ...
            <p>
              A checkout form including a billing address and summary of
              shopping card
            </p>
          </ex-card>
          <ex-card>
            ...
            <p>
              Typical web page including a main part and three responsive
              article cards under it.
            </p>
          </ex-card>
          <ex-card>
